...
/*   Updated: 2019/12/11 17:02:30 by rcorke        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void		put_ascii_art(WINDOW *win)
{
	...
	mvwprintw(win, INFO_START_Y + 25, 4, SIG8);
	mvwprintw(win, INFO_START_Y + 26, 4, SIG9);
	mvwprintw(win, INFO_START_Y + 27, 4, SIG10);
	mvwprintw(win, INFO_START_Y + 28, 4, SIG11);
	mvwprintw(win, INFO_START_Y + 29, 4, SIG12);
