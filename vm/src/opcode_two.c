...
/*   Updated: 2019/12/12 13:40:11 by rcorke        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void		op_and(t_game *game, t_cursor *cursor)
{
	...
	{
		value1 = get_arg_value(op_args->arg1_type, op_args->arg1_value, \
		cursor, game->board);
		value2 = get_arg_value(op_args->arg2_type, op_args->arg2_value, \
		cursor, game->board);
