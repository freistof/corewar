...
/*                                                   +#+                      */
/*   Created: 2019/11/21 19:15:03 by fblom         #+#    #+#                 */
/*   Updated: 2019/11/21 19:15:03 by fblom         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
t_op g_op_tab[17] =
{
	{"live", 1, {T_DIR, 0, 0}, {0}, 1, 10, "alive", 0, 0, 0},

	{"ld", 2, {T_DIR | T_IND, T_REG, 0}, {0}, 2, 5, "load", 1, 0, 0},

	{"st", 2, {T_REG, T_IND | T_REG}, {0}, 3, 5, "store", 1, 0, 0},

	{"add", 3, {T_REG, T_REG, T_REG}, {0}, 4, 10, "addition", 1, 0, 0},

	{"sub", 3, {T_REG, T_REG, T_REG}, {0}, 5, 10, "soustraction", 1, 0, 0},
	...
	{"zjmp", 1, {T_DIR, 0, 0}, {0}, 9, 20, "jump if zero", 0, 1, 0},
	...
	{"fork", 1, {T_DIR, 0, 0}, {0}, 12, 800, "fork", 0, 1, 0},

	{"lld", 2, {T_DIR | T_IND, T_REG, 0}, {0}, 13, 10, "long load", 1, 0, 0},

	{"lldi", 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, {0}, 14, 50,
		"long load index", 1, 1, 0},

	{"lfork", 1, {T_DIR, 0, 0}, {0}, 15, 1000, "long fork", 0, 1, 0},

	{"aff", 1, {T_REG, 0, 0}, {0}, 16, 2, "aff", 1, 0, 0},
